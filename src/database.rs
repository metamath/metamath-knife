...
impl Database {
    ...
    #[must_use]
    pub fn get_outline_node(&self, sref: StatementRef<'_>) -> OutlineNodeRef<'_> {
        self.outline_result().statement_node(sref.address(), self)
    }

    /// Returns the root outline node, at the level of the whole database
    #[must_use]
    pub fn root_outline_node(&self) -> OutlineNodeRef<'_> {
        self.outline_result().root_node(self)
    }
